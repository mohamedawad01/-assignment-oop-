...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2980177843ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="211">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=images">`test`.`images`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=images&table=images">`images`.`images`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=friday&table=users">`friday`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dummy_base&table=productlines">`dummy_base`.`productlines`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blog&table=posts">`blog`.`posts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=danny_diner&table=sales">`danny_diner`.`sales`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=danny_diner&table=members">`danny_diner`.`members`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=danny_diner&table=menu">`danny_diner`.`menu`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=danny_diner&table=Sales">`danny_diner`.`Sales`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=contact_app&table=companies">`contact_app`.`companies`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2c5f6539605c746d273955455921305d">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="211"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
